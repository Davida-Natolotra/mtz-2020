...
urlpatterns = [
    ...
    path('api/motos/archiveMoto/<int:pk>', views.archive_moto_API, name='archive_moto_API'),
    ...
    path('api/motos/check_num_moteur_unique/<str:num_moteur>', views.check_num_moteur_unique)
]
